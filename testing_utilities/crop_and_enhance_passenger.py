...
# =========== About this script ===========
# This script is a standalone video preprocessing utility script that:
# 1. Reads a video file or camera input.
# 2. Crops 20% from all sides of the frame.
# 3. Applies image processing for lighting robustness.
# 4. Saves the processed video to a new file.

# THIS SCRIPT IS NOT PART OF THE MAIN RECORDING SYSTEM.
# It is intended for testing and preprocessing passenger camera footage before analysis.
# ==========================================
